...
/**
 * 创建ServletContextListener，目标是在系统启动时添加自定义的属性，以便于在全局范围内可以随时调用。
 * 系统启动的时候Tomcat 中的 StandardContext 会调用ServletContextListener实现类的contextlnitialized方法，
 * 所以需要在这个方法中实现我们的初始化逻辑
 * <p>
